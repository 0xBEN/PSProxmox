function Get-ProxmoxNodeHostsFile {
    ...
    process {
        ...
        $ProxmoxNode | ForEach-Object {
            ...
            $uri = $proxmoxApiBaseUri.AbsoluteUri + "nodes/$($_.node)/hosts"
            try {
                ...
                if ($NoCertCheckPSCore) { # PS Core client                    
                    ...
                    -WebSession $ProxmoxWebSession | Select-Object -ExpandProperty data | Select-Object -ExpandProperty data
                }
